...
function MyProfile({
  ...
  async function refreshToken() : Promise<any> {
    ...
    await axios.get(
      ...
      { withCredentials: true }
        ...
        setQRUrl("http://localhost:8080/api/2fa/qrcode");
      })
      .catch((error:any) => {
  ...
  async function fixProfile() {
    ...
    if (is2Fa === "false" && checkIs2Fa === true) {
      ...
      if (jwtExpItem){
       ...
       try{
          ...
          const faChangeApiUrl = 'http://localhost:8080/api/2fa/turn-on';
          const dataToUpdate = {
            id: userId,
    ...
    try{
        ...
        const faChangeApiUrl = 'http://localhost:8080/api/2fa/turn-off';
        const dataToUpdate = {
          id: userId,
          twoFactorAuthCode: verCode
        };
